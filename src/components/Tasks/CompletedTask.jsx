...
export default function CompletedTask({
  ...
  return (
    <div className="relative flex justify-between gap-7 flex-col h-full w-80 rounded shrink-0 px-7 py-8 bg-[#008235]">
      ...
      <div className="flex items-center">
        {isRequested ? (
          <button className="flex items-center justify-center gap-3 w-full px-5 py-1 text-lg bg-green-800 border-2 border-gray-700 rounded-2xl cursor-pointer font-medium text-gray-50">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 15 15"
          ...
          <button
            ...
            className="flex justify-center items-center gap-3 w-full px-5 py-1 text-lg bg-green-800 border-2 border-gray-700 rounded-2xl cursor-pointer font-medium text-gray-50"
          >
            <svg
              width="20px"
              height="20px"
